...
function the_writers_blog_notice(){
    ...
    <div class="notice notice-success is-dismissible getting_started">
		<div class="notice-content">
			<h2><?php esc_html_e( 'Thanks for installing The Writers Blog Lite Theme', 'the-writers-blog' ) ?> </h2>
			...
			<div id="lite_theme" class="tabcontent open">
				...
				<div class="row">
					...
					<div class="theme-instruction-block col-md-7">
						<div class="pad-box">
		                    <p><?php esc_html_e( 'The Writers Blog is an elegant, feature-rich, sleek and versatile blog WordPress theme that makes the best use of the online space to enlighten visitors on various interesting topics. This multipurpose theme can be used as a blog, informative website, portfolio, landing page, resume, online journal, non-profits, consultants and for diverse niches. The Writers Blog is essentially for writers, journalists, authors, poets and similar people belonging to literature field to beautifully present their thoughts to make them most impactful. It is responsive, cross-browser compatible, translation ready and retina ready. It has a welcoming slider on the homepage to impress visitors at the very first sight. Its design is well thought to keep readers focus on content. This blog WordPress theme is developed on the latest WordPress version to make your website modern and advanced. It supports various post formats and offers various design options for different sections. The theme is highly customizable without requiring any previous coding knowledge; this makes you immensely powerful as a website owner. Its colour scheme can be chosen from a wide spectrum of colours; social media icons are there to give you fame. Its SEO is well working to get good traffic. ', 'the-writers-blog' ); ?></p>
							<ol>
