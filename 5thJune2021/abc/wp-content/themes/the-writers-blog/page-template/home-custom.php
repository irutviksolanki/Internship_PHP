...
<main id="main" role="main">
  ...
  <?php if( get_theme_mod('the_writers_blog_slider_arrows', false) != '' || get_theme_mod('the_writers_blog_enable_disable_slider', false) != ''){ ?>
    <section id="slider">
      <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel" data-interval="<?php echo esc_attr(get_theme_mod('the_writers_blog_slider_speed', 3000)); ?>"> 
              ...
              <div class="inner_carousel">
                ...
                <?php if( get_theme_mod('the_writers_blog_slider_metabox',true) != ''){ ?>
                  <div class="post-info text-center py-1 mb-2">
                    <i class="<?php echo esc_attr(get_theme_mod('the_writers_blog_post_date_icon_changer','fa fa-calendar')); ?> mr-1" aria-hidden="true"></i><span class="entry-date mr-2"> <?php echo esc_html(get_the_date()); ?></span>
                    <i class="<?php echo esc_attr(get_theme_mod('the_writers_blog_post_author_icon_changer','fa fa-user')); ?> mr-1" aria-hidden="true"></i><span class="entry-author mr-2"> <?php the_author(); ?></span>
                    <i class="<?php echo esc_attr(get_theme_mod('the_writers_blog_post_comment_icon_changer','fas fa-comments')); ?> mr-1"></i><span class="entry-comments mr-2"><?php comments_number( __('0 Comments','the-writers-blog'), __('0 Comments','the-writers-blog'), __('% Comments','the-writers-blog') ); ?></span>
                  </div>
                <?php } ?>
