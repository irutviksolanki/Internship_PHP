...
<body <?php body_class(); ?>>
	...
	<?php if(get_theme_mod('the_writers_blog_loader_setting',true)){ ?>
	    <div id="pre-loader">
			<div class='demo'>
					...
					<div class="top-menu pt-3">
						<div class="row m-0">
							<div class="col-lg-4 col-md-4">
								<div class="social-icons mt-2 text-lg-left text-center pl-3">
							...
							<div class="col-lg-4 col-md-4">
								<div class="search-box mt-2 text-lg-right text-center pl-3">
			      					<?php get_search_form(); ?>
		    					</div>
							</div>
						</div>
