<?php
	...
	/*--------------------------- Slider Opacity -------------------*/
	$the_writers_blog_slider_layout = get_theme_mod( 'the_writers_blog_slider_opacity_color','1');
	...
	$the_writers_blog_sliderbutton = get_theme_mod( 'the_writers_blog_enable_disable_scrolltop',true);
	if($the_writers_blog_sliderbutton == true && get_theme_mod( 'the_writers_blog_hide_show_scroll',true) == false){
